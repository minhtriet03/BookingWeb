        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bien_So = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValueSql: "(NULL)"),
                    Tinh_Trang = table.Column<bool>(type: "bit", maxLength: 50, nullable: true, defaultValueSql: "(NULL)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Account = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true, defaultValueSql: "(NULL)"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_ViTriGhe = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ID_Xe = table.Column<int>(type: "int", nullable: false, defaultValueSql: "(NULL)"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrangThai = table.Column<bool>(type: "bit", maxLength: 50, nullable: true, defaultValueSql: "(NULL)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_XeVeXes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_XeVeXes_vexe_VexeIdVe",
                        column: x => x.IdVe,
                        principalTable: "vexe",
                        principalColumn: "ID_Ve",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_XeVeXes_xe_XeIdXe",
                        column: x => x.IdXe,
                        principalTable: "xe",
                        principalColumn: "ID_Xe",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_XeVeXes_IdVe",
                table: "XeVeXes",
                column: "IdVe");

            migrationBuilder.CreateIndex(
                name: "IX_XeVeXes_IdXe",
                table: "XeVeXes",
                column: "IdXe");
        }
