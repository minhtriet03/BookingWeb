    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_xevitri", x => new { x.ID_Xe, x.ID_ViTri });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_VeXe = table.Column<int>(type: "int", nullable: false),
                    ID_ChuyenXe = table.Column<int>(type: "int", nullable: false),
                    NgayKhoiHanh = table.Column<DateOnly>(type: "date", nullable: true),
                    NgayDen = table.Column<DateOnly>(type: "date", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_vexechuyenxe", x => new { x.ID_VeXe, x.ID_ChuyenXe });
                    table.ForeignKey(
                        name: "FK_vexechuyenxe_chuyenxe",
                        column: x => x.ID_ChuyenXe,
                        principalTable: "chuyenxe",
                        principalColumn: "ID_ChuyenXe");
                    table.ForeignKey(
                        name: "FK_vexechuyenxe_vexe",
                        column: x => x.ID_VeXe,
                        principalTable: "vexe",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_vexechuyenxe_ID_ChuyenXe",
                table: "vexechuyenxe",
                column: "ID_ChuyenXe");
